    ...
    if (func.annotations.includes('query') || func.annotations.includes('composite_query')) {
        ...
        caller = async (options, ...args) => {
            ...
            if ((0, index_ts_1.isV3ResponseBody)(response.body)) {
                ...
                const certifiedRejectErrorCode = new errors_ts_1.CertifiedRejectErrorCode(requestId, reject_code, reject_message, error_code);
                certifiedRejectErrorCode.callContext = {
                    canisterId: cid,
                    methodName,
                    httpDetails: response,
            ...
            if (reply !== undefined) {
                ...
                throw errors_ts_1.UnknownError.fromCode(new errors_ts_1.UnexpectedErrorCode(`Call was returned undefined, but type [${func.retTypes.map(t => t.display()).join(',')}].`));
            }
        };
    }
