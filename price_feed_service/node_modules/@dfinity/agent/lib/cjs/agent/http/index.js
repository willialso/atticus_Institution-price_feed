    ...
    async call(canisterId, options, identity) {
        ...
        try {
            ...
            if (error instanceof errors_ts_1.AgentError) {
                ...
                else if (error.hasCode(errors_ts_1.IngressExpiryInvalidErrorCode)) {
...
function calculateIngressExpiry(maxIngressExpiryInMinutes, timeDiffMsecs) {
    return transforms_ts_1.Expiry.fromDeltaInMilliseconds(maxIngressExpiryInMinutes * MINUTE_TO_MSECS + timeDiffMsecs);
}
